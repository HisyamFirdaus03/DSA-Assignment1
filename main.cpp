        ...
        switch(select){
            case 1:
                ...
                if(userKey.length() != 9){
                    ...
                    userKey = "";
                    cout << "Invalid Matric No.! length" << endl;
                    break;
                }
...
void readFile(Lecturer *lect[], Subject *sub[], Student *stu[], int &lectCount, int &subCount, int &stuCount){
    ...
    ifstream inputLecturerFile("fileLecturers.txt");
    ...
    ifstream inputSubjectFile("fileSubjects.txt");
    ...
    ifstream inputStudentFile("fileStudents.txt");
...
void writeFile(Lecturer *lect[], Subject *sub[], Student *stu[], int lectCount, int subCount, int stuCount){
    ...
    ofstream outputFile("fileOutput.txt");
